...
const LeftSidebar = () => {
  ...
  return (
    <div className='w-[20%]'>
      <div>
        <div>
          <img className='ml-5' width={"40px"} src="https://w7.pngwing.com/pngs/708/311/png-transparent-icon-logo-twitter-logo-twitter-logo-blue-social-media-area-thumbnail.png" alt="twitter-logo"/>
        </div>  
        <div className='my-4'>
